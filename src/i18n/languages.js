export const translations = {
  ...
  de: {
    ...
    selectDates: "Bitte Daten auswählen",
    ...
    paymentSuccessfulMessage: "Ihre Buchung wurde erfolgreich bezahlt.",
  ...
  en: {
    ...
    paymentSuccessfulMessage: "Your booking has been successfully paid.",
  ...
  es: {
    ...
    paymentSuccessfulMessage: "Su reserva ha sido pagada exitosamente.",
